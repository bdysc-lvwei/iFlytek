...
public class PingyinUtils
{
	...
	public static String converterToFirstSpell(String chines)
	{
		...
		// 示例输出:lv1wei2shi4yi1ge4wei3da4de5ren2
	...
	{
		chines = filterPuntuation(chines);
		String pinyinName = "";
		char[] nameChar = chines.toCharArray();
		HanyuPinyinOutputFormat defaultFormat = new HanyuPinyinOutputFormat();
	...
	private static String filterPuntuation(String chines)
	{
	...
	{
		System.out.println(converterToFirstSpell("安徽建筑大学"));

		// System.out.println(converterToSpell("康师傅").toLowerCase());
		System.out.println(converterToSpell("吕伟是一个伟大的人"));
	}
}